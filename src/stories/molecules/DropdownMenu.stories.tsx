...
type DropdownMenuWithCustomArgs = ComponentProps<typeof DropdownMenu> & CustomArgs;
...
export const Default: Story = {
    ...
    render: ({ triggerChildren, labelChildren, itemChildren, disabled }: DropdownMenuWithCustomArgs) => (
        <DropdownMenu>
            <DropdownMenuTrigger>
                {triggerChildren}
            </DropdownMenuTrigger>
